...
class KakaoView(views.APIView):
    def get(self, request):
        ...
        response.set_cookie('access_token', access_token, httponly=True, domain='localhost:3000')
        response.set_cookie('refresh_token', refresh_token, httponly=True, domain='localhost:3000')
...
class RefreshTokenView(views.APIView):
    def post(self, request):
        try:
            ...
            response.set_cookie('access_token', serializer.data['access'], httponly=True, domain='localhost:3000')
            response.set_cookie('refresh token', serializer.data['refresh'], httponly=True, domain='localhost:3000')
            return response
